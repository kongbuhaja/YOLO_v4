...
sudo docker build --force-rm -f yolov4.dockerfile -t yolov4:tf213 .
sudo docker run --gpus '"device=0,1,2"' --cpuset-cpus=32-63 -m 128g --shm-size=16g -it -v /home/dblab/ML/YOLO_v4:/home/YOLO_v4 --name yolov4_13 yolov4:tf213