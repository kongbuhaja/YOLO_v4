...
sudo docker build --force-rm -f yolov4.dockerfile -t yolov4:tf212 .
sudo docker run --gpus '"device=0,1,2,3"' --cpuset-cpus=0-63 -m 128g --shm-size=16g -it -v /home/dblab/ML/YOLO_v4:/home/YOLO_v4 --name yolov4_12 yolov4:tf212