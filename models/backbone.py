...
class CSPDarknet53_scaled(Layer):
    def __init__(self, activate='Mish', kernel_initializer=glorot, **kwargs):
        ...
        self.resblock = DarknetBlock(64, 'Resnet', 1, activate=self.activate, kernel_initializer=self.kernel_initializer)
        self.csp_resblock1 = CSPDarknetBlock(128, 'Resnet', 2, activate=self.activate, kernel_initializer=self.kernel_initializer)
        self.csp_resblock2 = CSPDarknetBlock(256, 'Resnet', 8, activate=self.activate, kernel_initializer=self.kernel_initializer)
        self.csp_resblock3 = CSPDarknetBlock(512, 'Resnet', 8, activate=self.activate, kernel_initializer=self.kernel_initializer)
        self.csp_resblock4 = CSPDarknetBlock(1024, 'Resnet', 4, activate=self.activate, kernel_initializer=self.kernel_initializer)
    ...
    def call(self, input, training=False):
        ...
        small_branch = self.csp_resblock2(x, training)
        medium_branch = self.csp_resblock3(small_branch, training)
        large_branch = self.csp_resblock4(medium_branch, training)
